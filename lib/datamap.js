	...
	_createClass(Datamap, [{
		...
		value: function drawMap() {
			var _props = this.props,
			    ...
			    props = _objectWithoutProperties(_props, ['arc', 'arcOptions', 'bubbles', 'bubbleOptions', 'data', 'graticule', 'labels', 'updateChoroplethOptions', 'legend']);
